...
class UserExistsValidator extends AbstractValidator
{
    ...
    const NOT_SCALAR  = 'Недопустимое значение';
    const USER_EXISTS = 'Имя пользователя уже существует';
    ...
    protected $messageTemplates = array(
        self::NOT_SCALAR  => "Недопустимое имя пользователя",
        self::USER_EXISTS  => "Пользователь с таким именем уже существует"
    );
