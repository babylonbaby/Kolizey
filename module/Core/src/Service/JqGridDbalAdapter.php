...
//use Core\Hydrator\JqGrid2DoctrineDbal\FormWhere as WhereHydrator;
...
//            $fields[] = $this->getSelectItem($name, $element);
//        }
//        return $fields;
//    }
//
...
//     * @return string
//     */
//    protected function getSelectItem($name, \Zend\Form\Element $element)
//    {
...
//     * @return QueryBuilder
//     */
//    public function getQuery($inputData)
//    {
...
//     * @return mixed
//     */
//    protected function getTotal(QueryBuilder $query, $inputData)
//    {
//        $query = clone $query;
//
